...
namespace OrderTrackingApp.Migrations
{
    ...
    [Migration("20200706092832_AddOrderCartTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderTrackingApp.Models.OrderCart", b =>
                {
            ...
            modelBuilder.Entity("OrderTrackingApp.Models.OrderCart", b =>
                {
                    b.HasOne("OrderTrackingApp.Models.Item", "Item")
                        .WithMany("Cart")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("OrderTrackingApp.Models.Order", "Order")
                        .WithMany("Cart")
